        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BedStatus = table.Column<int>(type: "int", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    AddedByDoctorId = table.Column<int>(type: "int", nullable: true),
                    AddedByNurseId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientHistories_Doctors_AddedByDoctorId",
                        column: x => x.AddedByDoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId");
                    table.ForeignKey(
                        name: "FK_PatientHistories_Nurses_AddedByNurseId",
                        column: x => x.AddedByNurseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientNurses", x => new { x.PatientId, x.NurseId });
                    table.ForeignKey(
                        name: "FK_PatientNurses_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "NurseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientHistories_AddedByDoctorId",
                table: "PatientHistories",
                column: "AddedByDoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientHistories_AddedByNurseId",
                table: "PatientHistories",
                column: "AddedByNurseId");
